...
def get_eval_metrics(eval_info_list):
    ...
    for eval_info in eval_info_list:
        ...
        if eval_info['metric_type'] == 'Sum':
        ...
        elif eval_info['metric_type'] == 'Sigmoid':
            ...
            if 'eval_fg' in eval_info and eval_info['eval_fg']:
                eval_metrics.add(CrossEntropyAccFGMetric(config, metric_name=eval_info['metric_name'] + 'AccFG', binary_thresh=binary_thresh))
            ...
            if 'eval_fg' in eval_info and eval_info['eval_fg']:
                eval_metrics.add(SoftmaxAccFGMetric(config, metric_name=eval_info['metric_name'] + 'AccFG', axis=axis))
