...
def get_symbol(data, inc_dilates):
    ...
    res2, dilate = residual_unitA(conv1_2, n_in_ch=64, n_out_ch1=128, n_out_ch2=128, act_first=False, dim_match=False,
                                  dilate=dilate, inc_dilate=inc_dilates[0], name='conv2')
    ...
    res3, dilate = residual_unitA(res2, n_in_ch=128, n_out_ch1=256, n_out_ch2=256, act_first=True, dim_match=False,
                                  dilate=dilate, inc_dilate=inc_dilates[1], name='conv3')
    ...
    res4, dilate = residual_unitA(res3, n_in_ch=256, n_out_ch1=728, n_out_ch2=728, act_first=True, dim_match=False,
                                  dilate=dilate, inc_dilate=inc_dilates[2], name='conv4')
    ...
    res6, dilate = residual_unitA(res5_8, n_in_ch=728, n_out_ch1=728, n_out_ch2=1024, act_first=True, dim_match=False,
                                  dilate=dilate, inc_dilate=inc_dilates[3], name='conv6')
    res6_act = mx.sym.Activation(data=res6, act_type='relu', name='res6_relu')
    # print res6_act.infer_shape(data=data_shape)[1]

    # conv7
    conv7 = separable_conv(res6_act, n_in_ch=1024, n_out_ch=1536, kernel=(3, 3), stride=(1, 1), dilate=(dilate, dilate), depth_mult=1024, name='conv7')
    ...
    return [None, None, None, conv8_act]
