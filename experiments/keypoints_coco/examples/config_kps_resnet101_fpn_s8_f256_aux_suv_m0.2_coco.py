...
config.network.sym = 'keypoints.symbols.sym_kps_data.fpn_symbol'
config.network.sym_body = 'keypoints.symbols.sym_kps_fpn.get_fpn_conv_feat'
...
# exp param
config.exp = 'resnet101_fpn_s8_f256_aux_suv_m0.2'
