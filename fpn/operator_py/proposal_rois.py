...
def proposal_rois(cls_prob, bbox_pred, im_info, is_train, config):
    ...
    if config.network.proposal_method == 'float':
        # rois = mx.contrib.sym.Proposal(cls_prob=cls_prob,
        #                                bbox_pred=bbox_pred,
        #                                im_info=im_info,
        #                                feature_stride=config.network.rpn_feat_stride,
